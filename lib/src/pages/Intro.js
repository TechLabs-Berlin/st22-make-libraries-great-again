...
const Intro = ({item}) => {
	return(
			<div class="d-flex flex-row" style={{background: "#457B9D"}}>
				<div className="main">
					<h2 className="intro-h2">{item.title}</h2>
					<p className="intro-p">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sagittis sed consequat accumsan, 
				...
				<div className="img-main">
					<img className="intro-img" src={intro} alt="sth"/>
				</div>
			</div>
	);					
}
